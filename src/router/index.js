...
export default new Router({
	routes: [{
		...
		{
			path: '/yibi/handfbarea',
			name: 'handfbarea',
			component: resolve => require(['@/views/area/handfbarea'], resolve),
		},
		{
			path: '/yibi/netfbarea',
			name: 'netfbarea',
			component: resolve => require(['@/views/area/netfbarea'], resolve),
		},
		{
			path: '/yibi/handbuy',
			name: 'handbuy',
		...
		},
		{
			path: '/yibi/handsell',
			name: 'handsell',
			component: resolve => require(['@/views/yibi/trade/handsell'], resolve),
		},
		{
			path: '/yibi/netbuy',
			name: 'netbuy',
		...
		},
		{
			path: '/yibi/netsell',
			name: 'netsell',
			component: resolve => require(['@/views/yibi/trade/netsell'], resolve),
		},
		{
			path: '/yibi/needyb',
			name: 'needyb',

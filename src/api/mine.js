...
export const getBuyALlInfo = data => Axios({
	url:'/UCenter/getBuyOrderList/v.1.1/Test.Test/'+data.token+'/'+data.userId+'/10/0/'+data.getStatus+'/1',
	method:'get',
	data
})
...
export const SellBuyALlInfo = data => Axios({
	url:'/UCenter/getSellOrderList/v.1.1/Test.Test/'+data.token+'/'+data.userId+'/10/0/'+data.getStatus+'/1',
	method:'get',
	data
})
//获取下单list
export const huoquxiadanList = data => Axios({
	url:'/UCenter/getGameDanbaoJishouGoldSellOrderList/v.1.1/Test.Test/'+data.token+'/'+data.userId+'/10/0/1',
	method:'get',
	data
})
//发布管理
export const FAbuListData = data => Axios({
	url:'/UCenter/getGoodsList/v.1.1/Test.Test/'+data.token+'/'+data.userId+'/10/0/'+data.getStatus+'/1',
	method:'get',
	data
})
//买卖担保交易信息详情
...
export const mineRouter = data => Axios({
	url: '/UCenter/getUserMoneyList/v.1.1/Test.Test/'+data.token+'/'+data.userId+'/10/0/1',
	method: 'get',
	data
})
//我的收藏
export const myCollectData = data  => Axios({
	url: '/User/getMyCollect/v.1.1/Test.Test/'+data.token+'/'+data.userId+'/10/0/1',
	method: 'get',
	data
})
//提交反馈
...
export  const extractData = data => Axios({
	url: '/UCenter/getUserJicunList/v.1.1/Test.Test/'+data.token+'/'+data.userId+'/10/0/1',
	method: 'get',
	data
})
// 资产个人游戏币可提取列表
export  const extractIfo = data => Axios({
	url: '/UCenter/getUserDrawList/v.1.1/Test.Test/'+data.token+'/'+data.userId+'/10/0/1',
	method: 'get',
	data
})
